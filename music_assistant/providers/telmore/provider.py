...
from music_assistant.providers.telmore.library import TelmoreLibraryManager
from music_assistant.providers.telmore.media import TelmoreMediaManager
from music_assistant.providers.telmore.playlist import TelmorePlaylistManager
from music_assistant.providers.telmore.recommendations import TelmoreRecommendationsManager
from music_assistant.providers.telmore.streaming import TelmoreStreamingManager
...
class TelmoreMusikProvider(MusicProvider):
    ...
    async def handle_async_init(self) -> None:
        ...
        self.auth = TelmoreAuthManager(self)
        self.api = TelmoreAPIClient(self)
        self.library = TelmoreLibraryManager(self)
        self.media = TelmoreMediaManager(self)
